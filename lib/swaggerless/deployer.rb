        ...
        path_config.each do |method, method_config|
          if method_config['operationId'] then
            if deployedOperations[method_config['operationId']] == nil then
              ...
              deployedOperations[method_config['operationId']] = deploy_lambda(lambda_role_arn, function_name, method_config["summary"], method_config['x-amazon-lambda-runtime'] || 'nodejs4.3', method_config['operationId'])
            end
